...
class Contacts extends Table with TableInfo<Contacts, ContactsData> {
  ...
  late final GeneratedColumn<String> signalVersion = GeneratedColumn<String>(
    'signal_version',
    aliasedName,
    false,
    type: DriftSqlType.string,
  ...
  ContactsData map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return ContactsData(
      ...
      signalVersion: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
...
class ContactsData extends DataClass implements Insertable<ContactsData> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    map['signal_version'] = Variable<String>(signalVersion);
  ...
  factory ContactsData.fromJson(
    ...
    return ContactsData(
      ...
      signalVersion: serializer.fromJson<String>(json['signalVersion']),
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'signalVersion': serializer.toJson<String>(signalVersion),
...
class ContactsCompanion extends UpdateCompanion<ContactsData> {
  ...
  final Value<String> signalVersion;
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (signalVersion.present) {
      map['signal_version'] = Variable<String>(signalVersion.value);
    }
...
class Groups extends Table with TableInfo<Groups, GroupsData> {
  ...
  late final GeneratedColumn<int> deleteMessagesAfterMilliseconds =
      GeneratedColumn<int>(
        ...
        type: DriftSqlType.int,
        requiredDuringInsert: false,
        defaultValue: const Constant(86400000),
      );
  late final GeneratedColumn<DateTime> createdAt = GeneratedColumn<DateTime>(
    'created_at',
    aliasedName,
